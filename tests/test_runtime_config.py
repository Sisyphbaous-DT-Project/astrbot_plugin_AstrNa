    ...
    config = merge_config(
        {
            ...
            "optimize_tool_history_context": True,
            ...
            "parallel_tool_use_allowlist": ["search", "weather"],
            "provider_session_headers_enabled": True,
            "provider_session_headers_user_agent": False,
            "provider_session_headers_extra_name": "x-session-id",
